...
ua = ["Mozilla/5.0 (Linux; Android 13; V2199A; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36",]
ugen2=[]
ugen=[]
cokbrut=[]
...
def crack_file():
	os.system('clear')
	print(logo)
	print('\x1b[1;92m[•]\033[1;37m ━\x1b[1;92m Example:\033[1;37m /sdcard/70.txt ')
...
#-----------------------------------------------------#
vers = requests.get('https://raw.githubusercontent.com/TEAM70-Hentai-X/version/main/version.txt').text
version = str(vers)
#-------------------------------#
#os.system('xdg-open https://www.facebook.com/profile.php?id=100000273902530')
logo = (f"""
\033[38;5;46m 
██████   █████  ███    ██  █████  
██   ██ ██   ██ ████   ██ ██   ██ 
...
\033[92;1m<>  \033[1;37mCEO           \033[1;32m :   \033[1;97m\033[92;1mRANA   {version}{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆""")
def linex():
        print(f'{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆')
def clear():
	os.system('clear')
